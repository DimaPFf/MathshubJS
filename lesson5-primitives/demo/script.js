...
border_width.placeholder = 'Введите ширину'

const border_height = createEl('input')
border_height.type = 'number'
border_height.placeholder = 'Введите высоту'

const border_fatness = createEl('input')
border_fatness.type = 'number'
border_fatness.placeholder = 'Введите толщину'
...
userMessage.placeholder = 'Введите вопрос'
...
userString.placeholder = 'Введите строку'

const userLetter = createEl('input')
userLetter.placeholder = 'Введите букву'
...
userLongString.placeholder = 'Введите строку'
